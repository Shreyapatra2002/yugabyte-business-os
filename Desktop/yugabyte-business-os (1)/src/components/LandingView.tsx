...
import { whyBOSFeatures, faqItems } from '../data';
import heroBanner from '../assets/images/bos_hero_banner_1780387667910.png';
import jewelleryVisual from '../assets/images/jewellery_atelier_visual_1780387685581.png';
import manufacturingVisual from '../assets/images/manufacturing_blueprint_visual_1780387703104.png';
...
const aiBusinessSolutions = [
  {
    id: 'crm',
    name: 'BOS CRM',
    tagline: 'Customer relationships, unified',
    color: 'from-blue-500 to-indigo-500',
    icon: Users,
    highlights: [
      'Lead capture & pipeline tracking',
      'Communication history in one place',
      'Team assignment & follow-up automation'
    ]
  },
  {
    id: 'erp',
    ...
    highlights: [
      ...
      'Finance, HR & operations sync',
      'Multi-branch resource visibility'
    ]
  },
  {
    id: 'hms',
    ...
    highlights: [
      ...
      'Billing, pharmacy & lab workflows',
      'Staff roles & compliance tracking'
    ]
  },
  {
    id: 'pos',
    name: 'POS',
    tagline: 'Point of sale, retail-ready',
    color: 'from-emerald-500 to-teal-500',
    icon: ShoppingCart,
    highlights: [
      'Fast checkout & receipt generation',
      'Real-time stock deduction',
      'Multi-outlet sales reporting'
    ]
  },
  {
    id: 'education',
    name: 'Education OS',
    tagline: 'Campus & learning operations',
    color: 'from-amber-500 to-orange-500',
    icon: GraduationCap,
    highlights: [
      'Student enrollment & attendance',
      'Fee management & parent portals',
      'Course scheduling & grade tracking'
    ]
  },
  {
    id: 'analytics',
    name: 'Analytics',
    tagline: 'Data-driven decision engine',
    color: 'from-cyan-500 to-blue-500',
    icon: LineChart,
    highlights: [
      'Real-time dashboards & KPIs',
      'Revenue & performance reports',
      'Branch-wise growth insights'
    ]
  },
  {
    id: 'funnel',
    name: 'Funnel Intelligence',
    tagline: 'Conversion path optimization',
    color: 'from-fuchsia-500 to-indigo-500',
    icon: GitBranch,
    highlights: [
      'Lead-to-deal funnel visualization',
      'Drop-off detection & scoring',
      'AI-powered next-best-action hints'
    ]
  }
];
...
export default function LandingView({ setView }: LandingViewProps) {
  ...
  return (
    <div className="bg-slate-950 font-sans text-slate-100 min-h-screen overflow-x-hidden">
      
      {/* SECTION 1: Deep Tech Enterprise Hero */}
      <section className="relative pt-20 sm:pt-24 pb-14 sm:pb-20 items-center justify-center flex flex-col px-4 sm:px-6 lg:px-8 border-b border-slate-900 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 bg-blue-600/10 border border-blue-500/20 rounded-full mb-5 sm:mb-6 animate-float"
          >
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight font-sans text-slate-100 leading-tight px-1"
          >
          ...
          <motion.p
            ...
            className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed px-1"
          >
          ...
          >
            <motion.button
              ...
              className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 rounded-2xl text-xs font-bold tracking-wide shadow-lg shadow-blue-500/15 text-white flex items-center justify-center gap-2 group transition-all cursor-pointer"
            >
            ...
            <motion.button
              ...
              className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 bg-slate-900 hover:bg-slate-850 rounded-2xl text-xs font-semibold text-slate-350 border border-slate-800 hover:border-slate-700 transition-all cursor-pointer"
            >
              Industry Solutions
            </motion.button>
          </motion.div>
          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden border border-slate-800/80 bg-slate-950">
              ...
              <div className="relative aspect-[16/9] w-full bg-slate-950">
                ...
                <div className="absolute top-3 left-3 sm:top-6 sm:left-6 hidden sm:block backdrop-blur-md bg-slate-950/60 p-3 rounded-xl border border-slate-800/65 max-w-[200px] text-left transition-all hover:border-slate-700 shadow-lg">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent flex items-end p-4 sm:p-6 md:p-10">
                  <div className="text-left space-y-2 backdrop-blur-md bg-slate-950/60 p-3 sm:p-4 md:p-6 rounded-2xl border border-slate-800/80 max-w-lg shadow-2xl w-full">
          ...
          {/* Key Trust Pillars */}
          <div className="mt-10 sm:mt-12 pt-8 sm:pt-10 border-t border-slate-900/60 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 text-left max-w-3xl mx-auto">
            {[
              { value: '100%', label: 'Fast & No Bloat' },
              { value: 'Gemini AI', label: 'Smart Local AI Helper' },
              { value: 'Multi-Branch', label: 'Localized Workspace Sync' },
              { value: 'Ready To Use', label: 'Zero Setup Onboarding' },
            ].map((item, i) => (
              <motion.div
                key={item.label}
                initial={{ opacity: 0, y: 16 }}
              ...
              >
                <p className="text-base sm:text-lg font-bold font-mono text-slate-100">{item.value}</p>
                <p className="text-[9px] sm:text-[10px] font-mono text-slate-500 uppercase mt-0.5 font-bold tracking-wider leading-snug">{item.label}</p>
              </motion.div>
            ))}
          </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-12 gap-5 relative w-full">
              ...
              >
                <div className="relative aspect-[3/4] w-full rounded-xl overflow-hidden bg-slate-950 border border-slate-900/60 flex items-center justify-center">
                  <img 
                    src={
                      activeSector === 'Jewellery' ? jewelleryVisual :
                      activeSector === 'Manufacturing' ? manufacturingVisual :
            ...
            {keyFunctions.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative bg-slate-900/20 border border-slate-900/80 rounded-2xl p-5 overflow-hidden cursor-default transition-colors duration-300 hover:border-indigo-500/40 hover:bg-slate-900/55 hover:shadow-xl hover:shadow-indigo-500/10 focus-within:border-indigo-500/40 focus-within:bg-slate-900/55"
                  tabIndex={0}
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${item.color} opacity-0 group-hover:opacity-[0.07] group-focus-within:opacity-[0.07] transition-opacity duration-500 pointer-events-none`}
                  />

                  <div className="relative z-10 flex flex-col min-h-[120px]">
                    <div className="flex items-center justify-between mb-4">
                      <motion.div
                        className={`h-10 w-10 rounded-xl bg-gradient-to-tr ${item.color} p-0.5`}
                      ...
                      >
                        <div className="h-full w-full bg-slate-950 rounded-[9px] flex items-center justify-center">
                          <IconComponent
                            size={18}
                            className="text-slate-200 transition-transform duration-300 group-hover:scale-110 group-focus-within:scale-110"
                          />
                        </div>
                      </motion.div>
                      <span className="font-mono text-[10px] font-bold text-slate-600 tracking-wider group-hover:text-indigo-400/80 transition-colors duration-300">
                        {item.number}
                      </span>
                    </div>

                    <h3 className="text-sm font-sans font-bold text-slate-100 leading-snug group-hover:text-blue-400 group-focus-within:text-blue-400 transition-colors duration-300">
                      {item.title}
                    </h3>

                    <p className="mt-2 text-[10px] font-mono text-slate-600 uppercase tracking-wider group-hover:opacity-0 group-focus-within:opacity-0 transition-opacity duration-200">
                      Hover to explore
                    </p>
                    ...
                    <div className="grid grid-rows-[0fr] group-hover:grid-rows-[1fr] group-focus-within:grid-rows-[1fr] transition-[grid-template-rows] duration-500 ease-out">
                      <ul className="overflow-hidden min-h-0 space-y-2 pt-0 group-hover:pt-3 group-focus-within:pt-3">
                        {item.points.map((pt, i) => (
                          <motion.li
                            key={i}
                            initial={false}
                            className="flex items-start gap-2 text-xs text-slate-400 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 group-focus-within:opacity-100 group-focus-within:translate-y-0 transition-all duration-300"
                            style={{ transitionDelay: `${120 + i * 60}ms` }}
                          >
                            <span className="text-blue-500/80 font-mono font-bold text-[9px] select-none mt-1 shrink-0">
                              ↳
                            </span>
                  ...
                  <div className="relative z-10 mt-4 pt-3 border-t border-slate-900/50 flex justify-between items-center text-[9px] font-mono text-slate-600 font-bold uppercase tracking-wider">
                    <span className="group-hover:text-emerald-500/80 transition-colors duration-300">Ready</span>
                    <span className="h-1 w-8 rounded bg-slate-850 overflow-hidden relative">
                      <span className="absolute top-0 left-0 h-full w-0 bg-gradient-to-r from-blue-500 to-indigo-500 rounded transition-all duration-500 group-hover:w-full group-focus-within:w-full" />
                    </span>
                  </div>
                </motion.div>
              );
      ...
      {/* SECTION: Comprehensive Business Solutions Powered by AI */}
      <section id="ai-business-solutions" className="py-20 px-4 sm:px-6 lg:px-8 border-b border-slate-900 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-900/10 via-slate-950 to-slate-950 pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xs sm:text-sm text-slate-400 mt-4 leading-relaxed">
              One intelligent platform spanning CRM, ERP, healthcare, retail, education, analytics, and funnel intelligence — connected by Gemini AI so every module learns from your business data.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            {aiBusinessSolutions.map((solution, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative bg-slate-900/30 border border-slate-800/80 rounded-2xl p-6 overflow-hidden cursor-default transition-all duration-300 hover:border-blue-500/35 hover:bg-slate-900/60 hover:shadow-2xl hover:shadow-blue-500/10 focus-within:border-blue-500/35"
                  tabIndex={0}
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${solution.color} opacity-0 group-hover:opacity-[0.08] group-focus-within:opacity-[0.08] transition-opacity duration-500 pointer-events-none`}
                  />

                  <div className="relative z-10">
                    <div className="flex items-start justify-between mb-5">
                      <div className={`h-12 w-12 rounded-xl bg-gradient-to-tr ${solution.color} p-0.5 shadow-lg shadow-black/20`}>
                        <div className="h-full w-full bg-slate-950 rounded-[10px] flex items-center justify-center">
                          <IconComponent
                            size={20}
                            className="text-slate-100 transition-transform duration-300 group-hover:scale-110 group-focus-within:scale-110"
                          />
                        </div>
                      </div>
                      <motion.span
                        ...
                        className="text-[9px] font-mono font-bold text-blue-400/70 uppercase tracking-widest"
                      >
                        AI
                      </motion.span>
                    </div>

                    <h3 className="text-base font-sans font-bold text-slate-100 group-hover:text-blue-400 group-focus-within:text-blue-400 transition-colors duration-300">
                      {solution.name}
                    </h3>
                    ...
                    <p className="mt-3 text-[10px] font-mono text-slate-600 uppercase tracking-wider group-hover:opacity-0 group-focus-within:opacity-0 transition-opacity duration-200">
                      Hover for capabilities
                    </p>

                    <div className="grid grid-rows-[0fr] group-hover:grid-rows-[1fr] group-focus-within:grid-rows-[1fr] transition-[grid-template-rows] duration-500 ease-out">
                      <ul className="overflow-hidden min-h-0 space-y-2.5 pt-0 group-hover:pt-4 group-focus-within:pt-4">
                  ...
                  <div className="relative z-10 mt-5 pt-4 border-t border-slate-800/60 flex items-center justify-between">
                    <span className="text-[9px] font-mono text-slate-600 uppercase tracking-wider group-hover:text-emerald-500/80 transition-colors">
                      Integrated
                    </span>
                    <ArrowRight
                      size={14}
                      className="text-slate-600 group-hover:text-blue-400 group-hover:translate-x-1 group-focus-within:text-blue-400 transition-all duration-300"
                    />
                  </div>
                </motion.div>
              );
          ...
          >
            <button
              onClick={() => setView('dashboard')}
              className="inline-flex items-center gap-2 px-6 py-3 bg-slate-900 hover:bg-slate-850 border border-slate-800 hover:border-blue-500/30 rounded-xl text-xs font-semibold text-slate-300 hover:text-white transition-all cursor-pointer group"
            >
              <Sparkles size={14} className="text-blue-400" />
              <span>Explore the full BOS workspace</span>
